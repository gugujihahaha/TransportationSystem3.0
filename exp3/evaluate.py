...
def main():
    ...
    ALTERNATIVE_CACHE_PATHS = [
        ...
        'cache/processed_features_exp3.pkl',  # 其他命名
    ]
    ...
    model_paths_to_try = [
        MODEL_PATH,
        'checkpoints/exp3_model.pth',  # 旧版本模型
    ]
    ...
    try:
        ...
        plt.title('Exp3 Confusion Matrix (Trajectory + Spatial Features + Weather)', fontsize=14)
