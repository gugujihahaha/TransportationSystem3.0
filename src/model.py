...
class TransportationModeClassifier(nn.Module):
    ...
    def __init__(self, 
        ...
        # 特征融合层
        fusion_input_dim = hidden_dim * 2 + hidden_dim  # trajectory + kg
    ...
    def forward(self, trajectory_features: torch.Tensor, 
        ...
        """
        batch_size = trajectory_features.size(0)
...
class AttentionFusionModel(nn.Module):
    ...
    def forward(self, trajectory_features: torch.Tensor, 
        ...
        kg_padded = F.pad(kg_out, (0, trajectory_out.size(-1) - kg_out.size(-1)))
